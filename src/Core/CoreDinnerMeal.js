...
const CoreDinnerMeal = () => {
  ...
  const dinner = [
    {
      ...
      ingredients: "Water, Cooked Macaroni Pasta (17%) (Durum WHEAT Semolina, Emulsifier (Mono- and Diglycerides of Fatty Acids), Rapeseed Oil), Extra Mature Cheddar Cheese (12%) (MILK), Double Cream (MILK), Cornflour, Salt, Mustard Powder, Ground White Pepper.",
      ingredients2:
  ...
  
    {
      ...
      overview:
        "Tender lamb mince braised with onions, carrots, and swede cooked in a tomato lamb stock with delicate herbs like sage, rosemary and thyme. Topped with fresh thinly sliced potato.",
      ingredients: "Potato (29%), Lamb (25%), Water, Onion (9%), Carrot (8%), Swede (3%), Cornflour, Tomato Puree, Lamb Stock (Lamb, Yeast Extract, Water, Sugar, Cornflour, Salt, Concentrated Onion Juice, Rosemary Oil, Thyme Oil), Salt, Sugar, Worcester Sauce (Water, Spirit Vinegar, Sugar, Salt, Tamarind Paste, Onion Powder, GARLIC Powder, Lemon concentrate, Ground Ginger, Ground Cloves, Chilli Powder), Rosemary, Ground Black Pepper.",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
  ...
  
    {
      ...
      overview:
        "Our pork and tenderloin with mash will leave you feeling more than satisfied. Served with a creamy Dijon sauce.",
      ingredients: "Potatoes 43%, pork tenderloin 26% (pork tenderloin 20% (French origin), water, manioc starch, salt), water, onion 3%, single CREAM 1.5%, Dijon and traditional MUSTARDS 0.9% (water, MUSTARD seed, vinegar, salt), BUTTER 0.7%, rapeseed oil, salt, potato starch, nutmeg, plantain fibre, dehydrated onion, parsley 0.02%, pepper, turmeric.",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
  ...
  
    {
      ...
      overview:
        "No need to miss out on takeaway favourites with our Cantonese Pork & Rice. Succulent pork Cantonese style with rice.",
      ingredients: "Cantonese rice 44% (pre-cooked basmati rice, carrots, peas, SESAME oil, salt), cured and pre-cooked pork 20% (pork (French origin), water, starch, salt), water, soaked SOYA beans, onions, bamboo shoots 5%, SOY sauce (water, soy, WHEAT flour, salt), sugar, caramel 0.9% (sugar, water), starch, ginger 0.4%, double tomato paste, rapeseed oil, natural spice flavouring with other natural flavourings, salt, natural garlic flavouring.",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
  ...
  
    {
      ...
      overview:
        "A perfect lunchtime dish, no prep time needed. A perfectly balanced Tuna salad with a touch of vinegar to make the dish sing.",
      ingredients: "Skipjack TUNA 23%, water, pre-cooked pasta 18% (durum WHEAT semolina, water, EGG white powder), tomatoes 14%, maize 7%, carrots 7%, rapeseed oil, spirit vinegar, green beans, potato starch, salt, basil 0.3%, plantain fibre, natural basil flavouring.",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
  ...
  
    {
      ...
      overview:
        "Bursting with flavour and spice, one of our new favourites. Tender chicken breast and red pepper in a coconut style curry sauce with garlic, coriander, lemongrass turmeric, lime, chilli and brown basmati rice.",
      ingredients: "Chicken Breast (29%) [Contains Salt], Water, Coconut Milk [Coconut Extract, Water], Onion, Red Pepper (8.5%), Brown Basmati Rice (6%), Water Chestnut, Ginger Puree, Garlic Puree, Cornflour, Brown Sugar, Coriander, Lemongrass, Basil, Ground Turmeric, MUSTARD Seeds, Lime Leaf, Lime Juice, Chilli Powder, Ground White Pepper.",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
  ...
  
    {
      ...
      ingredients: "INGREDIENTS: Water, Chickpeas (14%), Butternut Squash (12%), Chopped Tomatoes (10%), Cannellini Beans (7%), Carrots, Onion, Dark Lentils (6%), Red Pepper, Honey, Cornflour, Olive Oil, Coriander, Salt, Tomato Puree, Ground Coriander, Ground Cumin, Ground Turmeric, Onion Powder, Lemon Juice, Ground Cassia, Ground Black Pepper, Chilli Powder.",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
  ...
  
    {
      ...
      overview:
        "Delicious and vibrant. Tender chicken breast in a spicy tomato sauce with garlic, basil, oregano, chilli and Penne pasta.",
      ingredients: "INGREDIENTS: Tomato (33%), Water, Chicken Breast (16%) (Contains Salt), Penne Pasta (13%) (Durum WHEAT Semolina, Emulsifier: E471), Tomato Puree, Onion, Tomato Passata, Honey, Cornflour, Olive Oil, Garlic, Sugar, Red Chilli, Basil, Oregano, Black Pepper, Chilli Powder.",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
  ...
  
    {
      ...
      overview:
        "Extremely tasty vegetarian chilli, hits of tomato, cumin, paprika and oregano cooked with a hunger beating portion of beans.",
      ingredients: "Water, Long Grain Rice (10%), Tomato, Pinto Beans (7%), Onion, Haricot Beans (7%), Cannellini Beans (6%), Kidney Beans (5%), Tomato Paste, Green Pepper, Red Pepper, Rapeseed Oil, Modified Maize Starch, Garlic Puree, Vegetable Stock (Partially Rehydrated Vegetables (Onion, Potato Flake, Leek), Yeast Extract, Salt, Carrot Concentrate, Sugar, Sunflower Oil, Lemon Juice Concentrate, Garlic), Salt, Ground Cumin, Coriander, Red Chilli Puree, Smoked Paprika, Ground Paprika, Dried Oregano, Chilli Powder, Black Pepper.",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
  ...
  const [counters, setCounters] = useState(dinner.map(() => 0));
                  ...
                  >
                    ...
                    <table className="table table-bordered">
                      ...
                      <tr>
                        <th>Fat</th>
                        <td>
                          {selectedCard && selectedCard?.nutrition_fat_per270g}
                        </td>
                        <td>
                          {selectedCard &&
