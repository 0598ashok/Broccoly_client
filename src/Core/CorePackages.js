...
//import images
import coreplan from "../images/core.jpg";
import breakfast from "../images/core-plan/Breakfast.png";
import lunch from "../images/core-plan/lunch.png";
import dinner from "../images/core-plan/Dinner.png";
import snack from "../images/core-plan/snack.png";
...
const CorePackages = () => {
  ...
  const handleChooseMeals = () => {
   ...
   navigate(
      `/diet-plans/coreplan/coremeals/${selectedGender.gender.toLowerCase()}/${selectedCard.price.toLowerCase()}`
    );
  };

  const content = (
    <>
      <b>What's included in the Core Plan?</b>
      <br />
      The Core Plan includes 28 days of meals and snacks, delivered direct to
  ...
  return (
    <div>
      <div className="container">
        <h5 className="core_packages_head">Core Plan</h5>
        <div className="row pb-5">
          <div className="col-lg-5 col-md-12 col-sm-12 p-0 core_plan_content">
            <div className="mb-5">
              <img src={coreplan} alt="core-img" className="img-fluid" />
            </div>
            ...
            <div className="card core_plan_card">
              ...
              <p>
                ...
                <span className="dropdown">
                  <a class="dropbtn">What’s included</a>
              ...
              <button className="core_mealbtn" onClick={handleChooseMeals}>
                Choose meals
              </button>
            </div>
          </div>
      ...
      >
        <div className="container core_plan_details">
          <h5 className="core_packages_head2">
            What will your menu be like on the Core Plan?
          </h5>
          ...
          <div className="row">
            <div className="col-12 jumbotron">
              <h1>Vegetarian Plan</h1>
              <p>
                A selection of over 50 vegetarian friendly meals and snacks,
