    ...
    <>
      <div className="pt-5 meal_grid">
        ...
        <MDBTabsContent>
          ...
          <MDBTabsPane open={basicActive === "tab3"}><CoreDinnerMeal/></MDBTabsPane>
          <MDBTabsPane open={basicActive === "tab4"}><CoreSnackMeal/></MDBTabsPane>
        </MDBTabsContent>
