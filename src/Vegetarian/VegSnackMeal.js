...
const VegSnackMeal = () => {
  const vegsnacksmeal = [
    {
      ...
      overview:
        "Dark chocolate coated cranberries to keep your chocolate cravings at bay.",
      ingredients:
        "Sugar, Cocoa mass, Palm oil, Cocoa butter, Whey powder (from MILK), Emulsifier: Sunflower lecithin, Glazing agents: Shellac, Gum arabic",
      ingredients2:
...

    {
      ...
      overview:
        "A delicious blend of raisins, cranberries, almonds, pumpkin and sunflower seeds.",
      ingredients:
        "Flame raisins (30%) (Raisins, Sunflower Oil), Dried sweetened cranberries (20%) (Sugar, Cranberries, Sunflower oil), ALMONDS (20%), Pumpkin seeds (15%), Sunflower seeds (15%)",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
...

    {
      ...
      overview:
        "A tasty mix of Raisins, Goji berries, Pumpkin Seeds & Sunflower Seeds.",
      ingredients:
        "Golden raisins (40%) (Raisins, Sunflower oil, Preservative: SULPHUR DIOXIDE), Dried goji berries (20%), Pumpkin seeds (20%), Raisins (10%) (Raisins, Sunflower oil), Sunflower seeds (10%).",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
...

    {
      ...
      overview:
        "Two delicious wholegrain oat biscuits made with toasted desiccated coconut and chia seeds. Perfect snack anytime of the day.",
      ingredients:
        "Wholegrain OATS (66%), Sustainable Palm Fruit Oil, Demerara Sugar, Dietary Fibre (Inulin), Partially Inverted Refiners Syrup; Lyles Golden Syrup, Tapioca Starch, Toasted Desiccated Coconut (2%), Chia Seeds (Salvia Hispanica) (2%), BARLEY Malt Syrup, Raising Agents (Ammonium Bicarbonate, Sodium Bicarbonate), Sea Salt, Natural Flavouring.",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
    ...
    },
    {
      ...
      ingredients:
        "Soya Pieces (Defatted Soya Flour 31%), Tapioca Starch, Salt) Potato Pieces (Dehydrated Potato (15%), Potato Starch (5%), Rice Flour, Salt), Sunflower Oil, Salt & Pepper Flavouring (Rice Flour, Sugar, Salt, Onion Powder, Spices, Yeast Extract, Garlic Powder, Natural Flavourings, Sunflower Oil, Antioxidant: Rosemary Extract), Black Pepper Extract",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
    ...
    },
    {
      ...
      ingredients:
        "Soya Pieces (Defatted SOYA Flour, Tapioca Starch, Salt), Potato Pieces (Dehydrated Potato, Potato Starch, Rice Flour, Salt), Paprika Flavour (Sugar, Yeast Extract, Onion Powder, Flavouring (contains CELERY), Salt, Tomato Powder, Colour: Paprika Extract; Acidity Regulator: Malic Acid; Sunflower Oil), Sunflower Oil, Fine Milled Flaxseed.",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
    ...
    },
    {
      ...
      overview:
        "Paprika adds a bit of spice to our crisp soya and potato snacks. These satisfyingly crisp snacks have a delicate seasoning that is tangy but not too hot",
      ingredients:
        "SOYA & Potato Pieces (SOYA Flour, Tapioca Starch, Dehydrated Potato, Potato Starch, Rice Flour, Salt), Sunflower Oil, Cheese & Onion Flavouring (Onion Powder, Maltodextrin, Sugar, Rice Flour, Yeast Extract, Salt, Dextrose Monohydrate, Natural Flavouring, Acidity Regulator: Citric Acid, Spice (White Pepper), Colour: Paprika Extract).",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
      nutrition_energy_per40g: "89 kcal (372 kJ)",
    ...
    },
    {
      ...
      overview:
        "These wholegrain oat biscuits are subtly flavoured with ginger, not overpowering at all...in fact just perfect. Very crumbly and utterly delicious.",
      ingredients:
        "Wholegrain OATS (64%), Demerara Sugar, Palm Oil, Stem Ginger (6.4%) (Stem Ginger, Sugar), Dietary Fibre, Potato Starch, Ground Ginger, Partially Inverted Sugar Syrup, Raising Agents: Ammonium Bicarbonate, Sodium Bicarbonate; BARLEY Malt Syrup, Sea Salt.",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
    ...
    },
    {
      ...
      ingredients:
        "Wholegrain OATS (66%), Palm Oil, Demerara Sugar, Dietary Fibre, Partially Inverted Syrup, Cranberries (3%) (Cranberries, Sugar, Sunflower Oil), Potato Starch, BARLEY Malt Syrup, Raising Agents: Ammonium Bicarbonate, Sodium Bicarbonate; Raspberry Puree Pieces (1%) (Raspberry, Apple Juice Concentrate, Apple Powder, Citrus Pectin), Sea Salt, Natural Flavouring.",
      ingredients2:
        "For allergens, including cereals containing Gluten, see ingredients in CAPITALS. May also contain traces of Nuts, Milk, Soya and Sesame.",
  ...
  const [counters, setCounters] = useState(vegsnacksmeal.map(() => 0));
  ...
  const filteredCards = vegsnacksmeal.filter((card) => {
