...
const VegLunchMeal = () => {
  ...
  const [counters, setCounters] = useState(veglunchmeal.map(() => 0));
  ...
  const filteredCards = veglunchmeal.filter((card) => {
      ...
      <div className="container">
        ...
        <div className="row">
          {filteredCards.length > 0 ? (
            // Display cards when there is data
                    ...
                    >
                      ...
                      <table className="table table-bordered">
                        ...
                        <tr>
                          ...
                          <td>
                            {selectedCard &&
                              selectedCard?.nutrition_fat_per200g}
                          </td>
                          <td>
                            {selectedCard &&
